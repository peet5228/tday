<template>
    <v-container fluid class="py-10">
                <v-card class="pa-4">
                    <h1 class=" text-h5 font-weight-bold text-maroon">ยืนยันผลการประเมิน</h1>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center border">
                                    ...
                                    <v-btn class="text-white" color="green"  size="small" @click="view(result.signature)">เปิดดู</v-btn>&nbsp;&nbsp;&nbsp;&nbsp;
